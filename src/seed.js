...
async function seedData() {
    ...
    try {
        ...
        await connection.query(`
            INSERT INTO treats (disease, symp, symptoms, herbs, treatment, alternate_name)
            VALUES

                ('Asthma', 
                '["respiratory", "gas", "temple pain", "heainess", "abdominal"]', 
                ...
                ('Arthritis', 
                '["joint pain", "heaviness", "fever", "indigestion", "inflamation"]', 
                ...
                ('Digestion', 
                '["bad digestion", "acidity", "bad taste", "vomiting"]', 
                ...
                ('Hypertension', 
                '["Headache", "red eyes","nose bleed","anger"]', 
                ...
                ('GallStones', 
                '["liver pain", "gallbladder pain", "swelling"]', 
